...
async function getUsers() {
    let data = await fetch("https://sis414examenn1-default-rtdb.firebaseio.com/users.json");
...
async function deleteUser(id) {
    await fetch( "https://sis414examenn1-default-rtdb.firebaseio.com/${id}.json", {
        method: "DELETE"
    });
    getUsers();
...
async function updateUser(rowData) {
    ...
    await fetch("https://sis414examenn1-default-rtdb.firebaseio.com/users.json", {
        method: "PUT",
        body: JSON.stringify(rowData),
        headers: {
            'Content-type': 'application/json; charset=UTF-8',
...
async function editUser(id) {
    const res = await fetch("https://sis414examenn1-default-rtdb.firebaseio.com/${id}.json");
...
async function guardarImagen() {
  const imagen = document.getElementById("imagen").files[0];
    const response = await fetch("https://sis414examenn1-default-rtdb.firebaseio.com/users.json");
